...
export const translations: Record<Lang, Dict> = {
  pl: {
    ...
    rec: {
      ...
      zasady: "Zasady rekrutacji", zasadySub: "2026/2027",
  ...
  en: {
    ...
    rec: {
      ...
      zasady: "Admission rules", zasadySub: "2026/2027",
  ...
  ru: {
    ...
    rec: {
      ...
      zasady: "Правила приёма", zasadySub: "2026/2027",
  ...
  uk: {
    ...
    rec: {
      ...
      zasady: "Правила вступу", zasadySub: "2026/2027",
  ...
  be: {
    ...
    rec: {
      ...
      zasady: "Правілы прыёму", zasadySub: "2026/2027",
  ...
  kk: {
    ...
    rec: {
      ...
      zasady: "Қабылдау ережелері", zasadySub: "2026/2027",
